import{a6 as e}from"./index-rrkVmw34.js";const o="lightFragmentDeclaration",v=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=v);const t="lightUboDeclaration",n=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);const r="imageProcessingDeclaration",d=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const i="imageProcessingFunctions",f=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=f);const a="shadowsFragmentFunctions",h=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=u);const c="reflectionFunction",p=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=p);const l="logDepthFragment",m=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=m);
//# sourceMappingURL=logDepthFragment-nzdfsXfw.js.map
