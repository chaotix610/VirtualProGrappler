import{a6 as e}from"./index-BpLpSt5r.js";const r="decalVertexDeclaration",I=`#ifdef DECAL
uniform vec4 vDecalInfos;uniform mat4 decalMatrix;
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=I);const t="uvAttributeDeclaration",E=`#ifdef UV{X}
attribute vec2 uv{X};
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=E);const i="prePassVertexDeclaration",u=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=u);const n="samplerVertexDeclaration",v=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying vec2 v_VARYINGNAME_UV;
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=v);const d="morphTargetsVertexGlobalDeclaration",R=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=R);const f="morphTargetsVertexDeclaration",S=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=S);const o="morphTargetsVertexGlobal",m=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=m);const a="morphTargetsVertex",_=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=_);const s="prePassVertex",l=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=l);const T="uvVariableDeclaration",x=`#if !defined(UV{X}) && defined(MAINUV{X})
vec2 uv{X}=vec2(0.,0.);
#endif
#ifdef MAINUV{X}
vMainUV{X}=uv{X};
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=x);const c="samplerVertexImplementation",N=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
if (v_INFONAME_==0.)
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=N);
//# sourceMappingURL=samplerVertexImplementation-3OG94GO5.js.map
