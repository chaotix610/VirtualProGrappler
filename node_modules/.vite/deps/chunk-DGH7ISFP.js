...
var name4 = "reflectionFunction";
var shader4 = `vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
var shader6 = `#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
var name7 = "logDepthFragment";
var shader7 = `#ifdef LOGARITHMICDEPTH
...
var name8 = "ltcHelperFunctions";
var shader8 = `vec2 LTCUv( const in vec3 N,const in vec3 V,const in float roughness ) {const float LUTSIZE=64.0;const float LUTSCALE=( LUTSIZE-1.0 )/LUTSIZE;const float LUTBIAS=0.5/LUTSIZE;float dotNV=saturate( dot( N,V ) );vec2 uv=vec2( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
//# sourceMappingURL=chunk-DGH7ISFP.js.map
