    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-Z3TNOQZH.js"), import("./pbr.fragment-W3NOSESC.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-WTELMDYX.js"), import("./pbr.fragment-WEMCW423.js")]);
        }
...
//# sourceMappingURL=chunk-53OXN3UI.js.map
