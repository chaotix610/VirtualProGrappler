...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-AQYZTIYE.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-ZWU474HO.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-GLDG62W6.js")]));
    }
  }
  /**
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-TR65KBIQ.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-XB4JNLRK.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-OSR647R3.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-DWBLZROR.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
//# sourceMappingURL=chunk-26K5AR33.js.map
