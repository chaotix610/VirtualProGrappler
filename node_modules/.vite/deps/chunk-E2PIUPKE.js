    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-SEHEOKWU.js"), import("./pbr.fragment-UUWDEHGJ.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-U33XY5YL.js"), import("./pbr.fragment-IIFSDAO5.js")]);
        }
...
//# sourceMappingURL=chunk-E2PIUPKE.js.map
